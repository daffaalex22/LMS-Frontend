    ...
    const getData = async () => {
      ...
      try {
        newDatas = await Axios.get(
          `http://52.14.19.229:8080/api/v1/modules/${moduleId}/videos`
        );
      } catch (e) {
        console.error(e);
        if (e.response) {
...
export const useReadingData = () => {
  ...
  useEffect(() => {
    ...
    const getData = async () => {
      ...
      try {
        newDatas = await Axios.get(
          `http://52.14.19.229:8080/api/v1/modules/${moduleId}/readings`
        );
      } catch (e) {
        console.error(e);
        if (e.response) {
...
export const useModuleData = () => {
  ...
  useEffect(() => {
    ...
    const getData = async () => {
      ...
      try {
        newDatas = await Axios.get(
          `http://52.14.19.229:8080/api/v1/modules/${moduleId}`
        );
      } catch (e) {
        console.error(e);
        if (e.response) {
...
export const useReadData = () => {
  ...
  useEffect(() => {
    ...
    const getData = async () => {
      ...
      try {
        newDatas = await Axios.get(
          `http://52.14.19.229:8080/api/v1/readings/${id}`
        );
      } catch (e) {
        console.error(e);
        if (e.response) {
