    ...
    const getData = async () => {
      ...
      try {
        newDatas = await Axios.get(
          "https://inedu-backend.onrender.com/api/v1/teachers/courses",
          config
        );
      } catch (e) {
        console.error(e);
...
export const useGetAllCategoryData = () => {
  ...
  useEffect(() => {
    ...
    const getData = async () => {
      let newDatas;
      try {
        newDatas = await Axios.get("https://inedu-backend.onrender.com/api/v1/categories");
      } catch (e) {
        console.error(e);
        if (e.response) {
          console.log(e.response);
...
export const useGetAllDifficultiesData = () => {
  ...
  useEffect(() => {
    ...
    const getData = async () => {
      let newDatas;
      try {
        newDatas = await Axios.get("https://inedu-backend.onrender.com/api/v1/difficulties");
      } catch (e) {
        console.error(e);
        if (e.response) {
          console.log(e.response);
